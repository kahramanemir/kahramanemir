<div align="center">
  <h1>Hi, I'm Emir Kahraman</h1>
  <p>
    Computer Engineering student building simulations, game systems, AI experiments,
    and practical backend tools.
  </p>
...
| [E-Commerce DBMS](https://github.com/kahramanemir/E-Commerce) | A database design project modeling a full e-commerce system with PostgreSQL schemas, triggers, and business workflows. | `PostgreSQL` `SQL` |

## Current Focus

- Building interactive systems with Unity and C#
...
[![Tech Stack](https://skillicons.dev/icons?i=cs,c,java,python,js,nodejs,postgresql,unity,git,github&theme=dark)](https://skillicons.dev)

## Creative Side

I also enjoy video editing and visual production alongside coding.
